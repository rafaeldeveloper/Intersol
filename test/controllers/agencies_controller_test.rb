...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { endereco: @agency.endereco, numero: @agency.numero } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { endereco: @agency.endereco, numero: @agency.numero } }
